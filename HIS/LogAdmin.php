...
<body>
    ...
    <div class="all ">
        <div class="row">
            <div class="col-lg-6 contain" style="background-image: linear-gradient(to left, #bbc5b2
            , #c9cdc6);">
                <div class="container">
                    <h2 class="text-center mt-5" style="color: rgb(177, 87, 87);" >Admin Login Form</h2>
                    <form action = "navbar.php" method ="POST" class="mt-5">
                        <div class="form-group">
                          <label for="usernameemail"  style="color: rgb(177, 87, 87);"  class="h6">Name Or Email</label>
                          <input type="email" class="form-control" id="usernameemail" aria-describedby="emailHelp" placeholder="Enter email" name="usernameemail" required>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="#" aria-pressed="true" style="text-decoration: none;">
                            <input type="submit"  class="btn btn-primary btn-lg btn-block mt-5 admin" style="background-color: #f68f6d !important; border:none; " name="submit" value="Log In"   >
                        </a>
                      </form>
                </div>
            </div>
            <div class="col-lg-6 second">
                <img src="images/cosmetic-dentistry-N2003.jpg" alt="Smile Person">
            </div>
        </div>
    </div>
